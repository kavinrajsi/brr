      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl mt-4 p-4 space-y-2">
        ...
        <ol className="text-xs text-blue-800 space-y-1 list-decimal list-inside">
          ...
          <li>
            ...
            <Link href={`/dashboard/brands/${brandId}/agents/${agentId}/test`} className="underline font-medium">
              Test Console
            </Link>
            .
          </li>
                  ...
                  <div className="flex items-start justify-between px-4 py-3 bg-white gap-4">
                    ...
                    <div className="flex flex-col items-end gap-2 shrink-0">
                      <div className="flex gap-2">
                        {scenario?.input_prompt && (
                          <Link
                            href={`/dashboard/brands/${brandId}/agents/${agentId}/test?scenario=${key}`}
                            title="Test this scenario in the console"
                            className="w-7 h-7 flex items-center justify-center rounded bg-blue-50 border border-blue-200 text-blue-600 hover:bg-blue-100"
                          >
